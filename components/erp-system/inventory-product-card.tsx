  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow border border-gray-200">
      <div className="relative">
        ...
        <Badge className={`absolute top-3 right-3 ${getStockStatusColor(stockStatus)}`}>{stockStatus}</Badge>
        {isLowStock && (
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div>
              ...
              <p className="font-medium text-gray-900">{productCategory}</p>
            </div>
            <div>
              <span className="text-gray-500">Supplier:</span>
              <p className="font-medium text-gray-900 truncate">{supplierName}</p>
            </div>
          </div>
